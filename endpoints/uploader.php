...
$model_prediction_time  = isset($_POST[$module::FIELD_MODEL_PREDICTION_TIME])    ? trim(filter_var($_POST[$module::FIELD_MODEL_PREDICTION_TIME], FILTER_SANITIZE_STRING)) : NULL ; 
...
if($valid_id){
    ...
    $module->uploadRecord($valid_id, $model_results, $model_config, $model_top_predictions, $model_prediction_time, $partner_ground_truth);
}else{
